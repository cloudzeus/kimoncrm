 ...
 * Manual stock sync endpoint (authenticated via session, not cron secret)
 */
export async function POST(request: NextRequest) {
  try {
    // Require authenticated user with admin/manager role
    ...
    console.log('📊 Manual stock sync summary:', summary);
